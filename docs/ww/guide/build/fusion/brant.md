...
{% tabs %}
{% tab title="Unflickering Valor 119%" %}
{% hint style="success" %}
Best In Slot
{% endhint %}
...
> Sword serbaguna yang luar biasa, karena bisa dapet bonusnya hampir tanpa syarat—kebanyakan **Resonator** emang selalu ngandelin skill **Intro** mereka, dan cuma sedikit karakter yang stay lebih dari **15 detik** di field selama durasi mereka.
